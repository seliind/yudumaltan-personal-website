        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-2 text-lg leading-8 text-gray-500">
              Aşğıda Yudum Altan Bakır tarafından yazılmış makaleleri inceleyebilirsiniz. Merak ettikleriniz ve daha fazla için iletişime geçiniz.
            </p>
          </div>
